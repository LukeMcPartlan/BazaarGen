...
class SkillGenerator {
  ...
  static buildSkillElement(skillData, mode, includeControls) {
    ...
    const frameConfigs = {
      legendary: { slice: '50 50 50 50 fill', width: '0 50px 0 50px', repeat: 'round' },
      gold: { slice: '60 60 60 60 fill', width: '0 60px 0 60px', repeat: 'round' }, // Using round to prevent stretching
      silver: { slice: '40 40 40 40 fill', width: '0 40px 0 40px', repeat: 'round' }, // Using round to prevent stretching
      bronze: { slice: '30 30 30 30 fill', width: '0 30px 0 30px', repeat: 'round' }, // Using round to prevent stretching
      diamond: { slice: '44 44 44 44 fill', width: '0 44px 0 44px', repeat: 'round' }
    };
